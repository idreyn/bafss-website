        ...
        <main className={classNames(isMapExpanded && 'map-expanded')}>
            <div className="centered-column">
                ...
                <p>
                    ...
                    have signed up to contribute 3d printing resources,
                    materials, and labor.
                </p>
                <p>
                    <strong>
                ...
                <p>
                    If you aren't in a position to work on this but would like
                    to support our efforts, contributors' time is entirely
                    donated, and we're buying all our supplies out of pocket at
                    local and online retail outlets. Defraying some of those
                    costs would be enormously helpful!
                </p>
                <h4>PayPal</h4>
                <p>
                    <form
                ...
                <p>
                    ...
                    <br></br>A face shield is not a mask that fits snugly over
                    the nose and mouth. It is a clear window that protects the
                    whole face from droplets and sprays that can carry
                    infection.
                </p>
                <p>
                    <strong>
                    ...
                    <br></br>
                    Yes. Personal protective equipment (PPE) is in short supply,
                    and there is no clear resupply chain in place currently.
                    <br></br>
                ...
                <p>
                    ...
                    <a href="https://www.nbcboston.com/news/coronavirus/mgh-desperately-needs-supplies-president-says/2094292/">
                        Massachusetts General Hospital and Partners hospitals in
                        the Boston area putting out a similar call
                    </a>{' '}
                ...
                <p>
                    ...
                    <br></br>
                    But the helpers on the map -- regular Bay Area people -- are
