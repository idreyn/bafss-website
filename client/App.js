                ...
                <div className="hero">
                    <div className="hero-pair">
                        ...
                        <p>
                            ...
                            pandemic. We are producing and distributing
                            3D-printed face shields, and we need your help.
                        </p>
                    </div>
                    <div className="hero-pair row-reverse">
                        ...
                        <p>
                            ...
                            nurses, EMTs, and pharmacists, because they help
                            prevent transmission of the novel coronavirus
                            through bodily fluids. They complement, rather than
                            replace, equipment like N95 respirators.
                        </p>
                    </div>
            ...
            <main>
                <div className="left-column">
                    <div className="map-explainer">
                        ...
                        <ul>
                            <li>
                                {dummyResponseMarker} volunteers are donating
                                their <span className="labor">labor</span>,{' '}
                                <span className="materials">materials</span>,{' '}
                                <span className="tools">tools</span>, and{' '}
                                <span className="funding">money</span>
                            </li>
                            <li>
                                {dummyDonationMarker} we've donated face shields
                    ...
                    <p>
                        ...
                        <br></br>A face shield is not a mask that fits snugly
                        over the nose and mouth. It is a clear window that
                        protects the whole face from droplets and sprays that
                        can carry infection.
                    </p>
                    <p>
                        <strong>
                        ...
                        supply, and there is no clear resupply chain in place
                        currently.
                        <br></br>
                    ...
                    <p>
                        ...
                        <a href="https://www.nbcboston.com/news/coronavirus/mgh-desperately-needs-supplies-president-says/2094292/">
                            ...
                            hospitals in the Boston area putting out a similar
                            call
                        </a>{' '}
                    ...
                    <p>
                        ...
                        time.
                        <br></br>
                        But the helpers on the map -- regular Bay Area people --
                        are the real contributors.
                    </p>
                    <p>
                        <strong>
                        ...
                        social distancing guidelines. We wipe everything down
                        and deliver materials with no-contact methods.
                    </p>
                    <p>
                        <strong>
